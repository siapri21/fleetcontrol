-- FleetControl Final Database Schema
-- MySQL Script for Evolved Model (with Anomalies)
...
-- New Table: anomalie (for full traceability of anomalies, causes, and financial impacts)
